...
export default class AddStudent extends Component {
    ...
    handleSubmit = (e) => {
        ...
        if(!/^[0-9]+$/.test(age)) {
            ...
            this.props.showAlert('Hours Paid should be only numbers', 'danger');
            return;
        }
        let student = {
            fname,
  ...
  render() {
    return (
        <div className="container">
            <h1 className='text-center mb-5'>Add Transaction Details</h1>
            <form className="row g-3" onSubmit={this.handleSubmit}>
                ...
                <div className="col-md-3">
                    <label htmlFor="validationDefaultAge" className="form-label">Hours Needed</label>

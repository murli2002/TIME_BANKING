...
export default function EditStudent(props) {
    ...
    const handleSubmit = (e) => {
        ...
        if(!/^[0-9]+$/.test(age)) {
            setAge("")
            props.showAlert('Hours of Work needed should be only numbers', 'danger');
            return;
        }
        if(address.length < 1) {
            setAddress("")
    ...
    const editStudent = (id, student) => {
        ...
        props.showAlert('success', 'Transaction updated successfully');
    ...
    return (
        <div className="container">
            ...
            <form className="row g-3" onSubmit={handleSubmit}>
                ...
                <div className="col-md-3">
                    <label htmlFor="validationDefaultAge" className="form-label">Hours</label>
